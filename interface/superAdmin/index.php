...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!--  absence nav -->
            <li class="nav-item active">
                <a class="nav-link" href="departement.php?matricule=<?php echo $matricule ?>">
            ...
            <li class="nav-item">
                <a class="nav-link " href="./filiere.php?matricule=<?php echo $matricule ?>">
            ...
            <li class="nav-item">
                <a class="nav-link " href="./users.php?matricule=<?php echo $matricule ?>" >
            ...
            <li class="nav-item">
                <a class="nav-link " href="./autorisation.php?matricule=<?php echo $matricule ?>" >
