...
if(isset($_GET['modifier'])) {
    $newID=$_GET['matricule'];
    $newName=$_GET['nom'];
    $newPrenom=$_GET['prenom'];
    $newrole=$_GET['role'];
    
    foreach($EST->users->user as $user){
		if($user['matricule']== $newID){
			$user['matricule']=$newID;
            $user['role']=$newrole;
            $user->nom=$newName;
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="" method="get">
                ...
                <input type="text" value="<?php echo $matricule?>" name="matricule" class="form-control" id="idDept" >
                </div>
                <div class="mb-3">
                <label for="nomDept" class="col-form-label">Nom :</label>
                <input type="text" value="<?php echo $nom?>" class="form-control" name="nom" id="nomDept"></input>
                </div>
                <div class="mb-3">
                <label for="nomDept" class="col-form-label">Prenom :</label>
                <input type="text" value="<?php echo $prenom?>" class="form-control" name="prenom" id="nomDept"></input>
                </div>
