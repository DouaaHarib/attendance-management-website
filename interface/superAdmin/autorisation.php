...
<!-- gestion des autorisation de chef departement -->
            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                        gestion des autorisation de chef departement</div>
                    <!-- <div class="h5 mb-0 font-weight-bold text-gray-800">$40,000</div> -->
                </div>
                <div class="col-auto">
                    <i class="fas fa-building-user fa-2x text-300"></i>
                </div>
            </div>
        </div>
    </div></a>
...
<!-- gestion des autorisation de chef de filiere -->
<div class="col-xl-3 col-md-6 mb-4">
    <a href="">
    <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                    gestion des autorisation de chef de filiere</div>
...
<!-- gestion des autorisation des proffeseures -->
<div class="col-xl-3 col-md-6 mb-4">
    <a href="autorisation-user.php">
    <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                    gestion des autorisation des proffeseures</div>
